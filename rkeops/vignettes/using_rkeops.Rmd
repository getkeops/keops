...
> In CPU mode, you can use the package 'RhpcBLASctl' to control the number of CPU cores used by RKeOps for computations. See <https://cran.r-project.org/package=RhpcBLASctl> and the function `RhpcBLASctl::omp_set_num_thread(nthreads)`.
