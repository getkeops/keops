...
When a single integer value `n` is encoded as a `LazyTensor`, its formula is simply `"IntCst(n)"`, which contains all the necessary information, and the `args` and `vars` attributes remain empty, to avoid useless storage.
