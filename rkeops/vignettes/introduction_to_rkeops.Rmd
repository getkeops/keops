...
You can also fill an issue report on Github at <https://github.com/getkeops/keops/issues>.
...
More details about input matrices (size, storage order) are given [here](rkeops_r_bindings_for_keops.html#input-matrix).
