...
//////////////////////////////////////////////////////////////////
 ...
 { 
  ...
  //------ the sixth input argument: beta---------------//
...
#if UseCudaOnDoubles   
   fshape_gpu_dx<double>(oosigmax2,oosigmaf2,oosigmaXi2,x,y,f,g,alpha,beta,gamma,dimpoint,dimsig,dimvect,nx,ny);
#else
   // convert to float
   ...
   fshape_gpu_dx<float>(oosigmax2,oosigmaf2,oosigmaXi2,x_f,y_f,f_f,g_f,alpha_f,beta_f,gamma_f,dimpoint,dimsig,dimvect,nx,ny);
