...
extern "C" int cudafshape(double ooSigmax2,double ooSigmaf2, double ooSigmaXi2, double* x_h, double* y_h, double* f_h, double* g_h, double* alpha_h, double* beta_h, double* gamma_h, int dimPoint, int dimSig, int dimVect, int nx, int ny){
    return fshape_gpu<double>(ooSigmax2,ooSigmaf2,ooSigmaXi2,x_h,y_h,f_h,g_h,alpha_h,beta_h,gamma_h,dimPoint,dimSig,dimVect,nx,ny);
}
