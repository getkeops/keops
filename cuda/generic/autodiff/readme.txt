...
La commande "compile" permet de compiler une formule arbitraire ; le fichier ".so" correspondant est placé dans le répertoire build
Pour vérifier que ça fonctionne, j'ai fait deux programmes test_link.cu et test_link_grad.cu qui testent une fonction et son gradient 
