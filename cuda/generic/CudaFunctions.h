...
public:
    ...
    CauchyFunction() { ooSigma2 = 1.0; ooSigma4 = 1.0; }
    
    CauchyFunction(TYPE sigma) { ooSigma2 = 1.0/(sigma*sigma); ooSigma4 = ooSigma2*ooSigma2; }
...
public:
    ...
    GaussFunction() { ooSigma2 = 1.0; ooSigma4 = 1.0; }
    
    GaussFunction(TYPE sigma) { ooSigma2 = 1.0/(sigma*sigma); ooSigma4 = ooSigma2*ooSigma2; }
...
public:
    ...
    LaplaceFunction() { ooSigma2 = 1.0; ooSigma4 = 1.0; }
    
    LaplaceFunction(TYPE sigma) { ooSigma2 = 1.0/(sigma*sigma); ooSigma4 = ooSigma2*ooSigma2; }
...
public:
    ...
    EnergyFunction() { ooSigma2 = 1.0; ooSigma4 = 1.0; }
    
    EnergyFunction(TYPE sigma) { ooSigma2 = 1.0/(sigma*sigma); ooSigma4 = ooSigma2*ooSigma2; }
...
public:
    ...
    Sum4GaussFunction() { ooSigma2 = 1.0; ooSigma4 = 1.0; }
    Sum4GaussFunction(TYPE sigma) { ooSigma2 = 1.0/(sigma*sigma); ooSigma4 = ooSigma2*ooSigma2; }
...
public:
    ...
    Sum4CauchyFunction() { ooSigma2 = 1.0; ooSigma4 = 1.0; }
    Sum4CauchyFunction(TYPE sigma) { ooSigma2 = 1.0/(sigma*sigma); ooSigma4 = ooSigma2*ooSigma2; }
