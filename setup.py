...
setup(
    ...
    packages=[
        ...
        "pykeops.keops",
        "pykeops.keops.binders",
        "pykeops.keops.binders.cpp",
        "pykeops.keops.binders.nvrtc",
        "pykeops.keops.config",
        "pykeops.keops.formulas",
        "pykeops.keops.formulas.autodiff",
        "pykeops.keops.formulas.complex",
        "pykeops.keops.formulas.maths",
        "pykeops.keops.formulas.reductions",
        "pykeops.keops.formulas.variables",
        "pykeops.keops.include",
        "pykeops.keops.mapreduce",
        "pykeops.keops.mapreduce.cpu",
        "pykeops.keops.mapreduce.gpu",
        "pykeops.keops.tests",
        "pykeops.keops.utils",      
    ],
    package_data={
