...
extern "C" int cudafshape_df(__TYPE__, __TYPE__, __TYPE__, __TYPE__*, __TYPE__*, __TYPE__*, __TYPE__*, __TYPE__*, __TYPE__*, __TYPE__*, int, int, int, int, int);
...
void ExitFcn(void) {}
 ...
 //prhs: double *x, double *y, double* f, double* g, double *alpha, double *beta, double sigmax, double sigmaf, double sigmaXi
  ...
  //------ the sixth input argument: beta---------------//
...
#if USE_DOUBLE
   cudafshape_df(oosigmax2,oosigmaf2,oosigmaXi2,x,y,f,g,alpha,beta,gamma,dimpoint,dimsig,dimvect,nx,ny);
#else
   // convert to float
   ...
   cudafshape_df(oosigmax2,oosigmaf2,oosigmaXi2,x_f,y_f,f_f,g_f,alpha_f,beta_f,gamma_f,dimpoint,dimsig,dimvect,nx,ny);
