...
class TestCase:
    def test_torch_func_vmap(self):
        ...
        assert_torch_allclose(res1, res2, atol=1e-5, label="torch_func_lse_vmap")
    ...
    def test_torch_func_vjp(self):
        ...
        assert_torch_allclose(res1, res2, atol=1e-5, label="torch_func_lse_vjp")
    ...
    def test_torch_func_jvp(self):
        ...
        assert_torch_allclose(res1, res2, atol=1e-5, label="torch_func_lse_jvp")
    ...
    def test_torch_func_jacfwd(self):
        ...
        assert_torch_allclose(res1, res2, atol=1e-5, label="torch_func_lse_jacfwd")

    def test_torch_func_hessian(self):
        res1 = torch.func.hessian(fn_torch)(x_i, y_j, b_j)
        res2 = torch.func.hessian(fn_keops)(x_i, y_j, b_j)
        assert_torch_allclose(res1, res2, atol=1e-5, label="torch_func_lse_hessian")
