...
Comparison with other related project
-------------------------------------

You may find `here <https://github.com/getkeops/keops/tree/master/benchmarks>` a benchmark that compare the performances of pyKeOps with other related projects.
