...
def generic_sum(formula, output, *aliases, **kwargs):
    """Alias for :class:`numpy.Genred <pykeops.numpy.generic.generic_red.Genred>` with a "Sum" reduction.

    Args:
        formula (string): Symbolic KeOps expression, as in :class:`numpy.Genred <pykeops.numpy.generic.generic_red.Genred>`.
        ...
        *aliases (strings): List of identifiers, as in :class:`numpy.Genred <pykeops.numpy.generic.generic_red.Genred>`.
    ...
    Returns:
        ...
        NumPy arrays, as documented in :class:`numpy.Genred <pykeops.numpy.generic.generic_red.Genred>`.
...
def generic_logsumexp(formula, output, *aliases, **kwargs):
    """Alias for :class:`numpy.Genred <pykeops.numpy.generic.generic_red.Genred>` with a "LogSumExp" reduction.

    Args:
        formula (string): Scalar-valued symbolic KeOps expression, as in :class:`numpy.Genred <pykeops.numpy.generic.generic_red.Genred>`.
...
def generic_argkmin(formula, output, *aliases, **kwargs):
    """Alias for :class:`numpy.Genred <pykeops.numpy.generic.generic_red.Genred>` with an "ArgKMin" reduction.
...
def generic_argmin(formula, output, *aliases, **kwargs):
    """Alias for :class:`numpy.Genred <pykeops.numpy.generic.generic_red.Genred>` with an "ArgMin" reduction.
