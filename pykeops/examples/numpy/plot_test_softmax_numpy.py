...
###############################################################################
# Using the :class:`numpy.Genred <pykeops.numpy.generic.generic_red.Genred>` class,
...
# ---------------
# 
# Create a new generic routine using the :class:`numpy.Genred <pykeops.numpy.generic.generic_red.Genred>`
# constructor:
