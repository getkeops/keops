...
def Subtract(arg0, arg1):
    ...
    if isinstance(arg0, (IntCst_Impl,RatCst_Impl)):
        if isinstance(arg1, Add_Impl) and isinstance(arg1.children[0], (IntCst_Impl,RatCst_Impl)):
            # m-(r+g) -> (m-r)-g
            return (arg0-arg1.children[0])-arg1.children[1]
        if isinstance(arg1, Subtract_Impl) and isinstance(arg1.children[0], (IntCst_Impl,RatCst_Impl)):
            # m-(r-g) -> (m-r)+g
            return (arg0-arg1.children[0])+arg1.children[1]
    if isinstance(arg1, (IntCst_Impl,RatCst_Impl)):
        if isinstance(arg0, Add_Impl) and isinstance(arg0.children[0], (IntCst_Impl,RatCst_Impl)):
            # (r+g)-m -> (r-m)+g
            return (arg0.children[0]-arg1)+arg0.children[1]
        if isinstance(arg0, Subtract_Impl) and isinstance(arg0.children[0], (IntCst_Impl,RatCst_Impl)):
            # (r-g)-m -> (r-m)-g
            return (arg0.children[0]-arg1)-arg0.children[1]
    ...
    if isinstance(arg0, Mult_Impl) and isinstance(arg1, Mult_Impl):
        ...
        if b==d:
            return b*(a-c)
    if isinstance(arg0, Mult_Impl) and isinstance(arg0.children[0], IntCst_Impl) and arg0.children[1] == arg1:
