...
class ConfigNew:
    ...
    def _load_OpenMP_libraries_mac(self):
        ...
        # Attempt to import common libraries that may load OpenMP
        ...
        if not success:
            # Attempt to directly load OpenMP libraries
            self._load_dll_mac()
    ...
    def _check_and_set_CUDA_support(self):
        self.cuda_message = ""
        if self.use_cuda:
