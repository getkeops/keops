from keops.formulas.Chunkable_Op import Chunkable_Op
from keops.formulas.variables.Zero import Zero
from keops.utils.code_gen_utils import c_zero_float, VectApply
...
class Sum_Impl(Chunkable_Op):
    ...
    def DiffT(self, v, gradin):
        from keops.formulas.maths.SumT import SumT
