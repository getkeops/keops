// test convolution
// compile with
//		nvcc -I.. -DCUDA_BLOCK_SIZE=192 -DMAXTHREADSPERBLOCK0=1024 -DSHAREDMEMPERBLOCK0=49152 -Wno-deprecated-gpu-targets -D__TYPE__=float -std=c++11 -O2 -o build/test_argmin test_argmin.cu
// 
...
int main() {
    ...
    using FUNCONVF = ArgMin_Reduction<F>;
