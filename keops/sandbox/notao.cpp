...
int main() {
    ...
    std::cout << "Prod Array0 : " << prod_array(array0) << std::endl;
    std::cout << "CumProd Array0 : " << cumprod_array(array0) << std::endl;
    std::cout << "Reverse Array0 : " << reverse_array(array0) << std::endl;
    std::cout << "concat Array0+Array1 : " << concat_array(array0, array1) << std::endl;
    ...
    std::cout << "sort_index Array0 : " << sort_indexes_array(array0) << std::endl;
    return 0;
}
