// test convolution
// compile with
//		g++ -I.. -D__TYPE__=float -std=c++11 -O2 -o build/test_kminargkmin test_kminargkmin.cpp
// 
...
int main() {
    ...
    using FUNCONVF = KMin_ArgKMin_Reduction<F,5>;

    // now we test ------------------------------------------------------------------------------

    std::cout << "Testing KMinArgKMin reduction" << std::endl;
