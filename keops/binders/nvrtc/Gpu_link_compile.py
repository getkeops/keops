...
class Gpu_link_compile(LinkCompile):
    ...
    def __init__(self):
        ...
        self.target_file = os.path.join(get_build_folder(), self.target_prefix+self.gencode_filename).encode("utf-8")
    ...
    def compile_jit_binary(self):
        ...
        if not os.path.exists(jit_binary):
            ...
            target_type_define = "-DnvrtcGetTARGET="+nvrtcGetTARGET+" -DnvrtcGetTARGETSize="+nvrtcGetTARGETSize
