...
def jit_compile_dll():
    return os.path.join(keops.config.config.build_path, "nvrtc_jit" + sysconfig.get_config_var('SHLIB_SUFFIX'))
...
class Gpu_link_compile(LinkCompile):
    ...
    def __init__(self):
        ...
        self.low_level_code_file = os.path.join(
            keops.config.config.build_path, self.low_level_code_prefix + self.gencode_filename
        ).encode("utf-8")
    ...
    def get_compile_command(
        ...
        target_tag = "CUBIN" if Gpu_link_compile.low_level_code_prefix == "cubin_" else "PTX"
