...
class Gpu_link_compile(LinkCompile):
    ...
    def __init__(self):
        ...
        # generated by the JIT compiler, e.g. 7b9a611f7e.tgt
        self.target_file = os.path.join(get_build_folder(), self.gencode_filename+"."+self.target_extension).encode("utf-8")
