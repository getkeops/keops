...
public:
  // constructors
  Sizes(int _nargs, __TYPE__** args, index_t* argshapes, int _nx, int _ny) {
...
private:
  void fill_shape(int nargs, __TYPE__** args, index_t* argshapes);
  
  void check_ranges(int nargs, __TYPE__** args, index_t* argshapes);
...
void Sizes::check_ranges(int nargs, __TYPE__** args, index_t* argshapes) {
...
void Sizes::switch_to_half2_indexing() {
