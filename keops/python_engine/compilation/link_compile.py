...
from keops.python_engine import use_cuda, jit_binary
...
class link_compile:
    ...
    def get_dll_and_params(self):
        ...
        file_to_check = self.low_level_code_file if use_cuda else self.dllname
        if not os.path.exists(file_to_check):
            ...
            self.read_info()
        dllname = jit_binary if use_cuda else self.dllname
        return dict(
            dllname=dllname,
