...
using Grad_WithSavedForward = typename F::template DiffT_WithSavedForward<V,GRADIN,FO>;
...
// same but with additional variable to input saved forward 
template < class F, class V, int I >
using Grad_WithSavedForward_FromPos = Grad_WithSavedForward<F,V,Var<I,F::DIM,F::CAT>,Var<I+1,F::DIM,F::CAT>>;
